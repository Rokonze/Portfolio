...
function About() {
  return (
    <div className='bg-gradient-to-b from-[#1f3c5c] to-[#314c6f] max-w-[1200px] h-auto mx-auto text-[#f9f4e8] flex flex-col  items-center my-8 py-8 rounded-3xl divide-y'>
